...
{
   QuteMsg(MSG_ERR) << "Calling virtual function VlpBaseNode::varFlatten() (Type = " << getNodeClass() << " !!!" << endl;
}

CktOutPin* 
VlpBaseNode::synthesis() const 
{ 
   QuteMsg(MSG_ERR) << "Calling virtual function VlpBaseNode::synthesis() (Type = " << getNodeClass() << " !!!" << endl;
   return 0;
}
...
{ 
   QuteMsg(MSG_ERR) << "Calling virtual function VlpBaseNode::synthesisAssign() (Type = " << getNodeClass() << " !!!" << endl;
   return 0;
}
...
{
   QuteMsg(MSG_ERR) << "Calling virtual function VlpBaseNode::isConst() (Type = " << getNodeClass() << " !!!" << endl;
   return false;
}
...
{
   QuteMsg(MSG_ERR) << "Calling virtual function VlpBaseNode::constPropagate() (Type = " << getNodeClass() << " !!!" << endl;
   return -1;
}
